...
void main() {
  ...
  testWidgets('Document Classifier Integration Test', (WidgetTester tester) async {
    ...
    expect(find.byType(PdfCardWidget), findsNWidgets(3));
    ...
    Iterable<PdfCardWidget> pdfCardWidgets = tester.widgetList(find.byType(PdfCardWidget));
    ...
    await tester.pumpAndSettle();
    expect(find.byType(PdfCardWidget), findsNWidgets(2));
